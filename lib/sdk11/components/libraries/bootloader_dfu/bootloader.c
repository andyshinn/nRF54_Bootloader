...
/* nRF54L: nrfx 4.x renamed nrf_wdt_started → nrf_wdt_started_check,
 * and the WDT instance is NRF_WDT31 (not NRF_WDT). */
#define nrf_wdt_started(p_reg)  nrf_wdt_started_check(p_reg)
#ifndef NRF_WDT
